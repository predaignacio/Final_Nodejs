...
var Timeout = (function () {
  ...
  function Timeout(eventQueue, fn, delay, remove) {
    ...
    this.next = _core.Date.now() + this.delay;
  }
...
var Interval = (function () {
  ...
  function Interval(eventQueue, fn, interval, remove) {
    ...
    this.next = _core.Date.now() + this.interval;
  }
...
var EventQueue = (function () {
  ...
  _createClass(EventQueue, [{
    ...
    value: function destroy() {
      ...
      try {
        for (var _iterator = _core.getIterator(this.timers), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = _core.getIterator(this.eventSources), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    get: function () {
      return !!(this.expecting || _core.Array.from(this.window.frames).filter(function (frame) {
    ...
    value: function dequeue() {
      ...
      try {
        for (var _iterator3 = _core.getIterator(_core.Array.from(this.window.frames)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    get: function () {
      ...
      var frames = _core.Array.from(this.window.frames).map(function (frame) {
...
module.exports = (function (_EventEmitter) {
  ...
  function EventLoop(browser) {
    ...
    _get(_core.Object.getPrototypeOf(EventLoop.prototype), 'constructor', this).call(this);
  ...
  _createClass(EventLoop, [{
    ...
    value: function wait(waitDuration, completionFunction, callback) {
      ...
      // further
      var timer = _core.global.setTimeout(timeout, waitDuration); // eslint-disable-line no-use-before-define
      var timeoutOn = _core.Date.now() + waitDuration;
      ...
      function ontick(next) {
        ...
        if (completionFunction && activeWindow.document.documentElement) try {
          var waitFor = Math.max(next - _core.Date.now(), 0);
